    ...
    <div>
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6">
          ...
          {/* Title */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-2">MY ACCOUNT</h2>
      ...
      <div className="h-auto flex items-center justify-center bg-gray-50 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 p-6 w-full max-w-4xl bg-white shadow-md rounded-md">
          {/* Login Section */}
